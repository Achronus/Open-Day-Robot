...
// (in-package pal_behaviour_msgs.srv)
...
let BehaviourArgument = require('../msg/BehaviourArgument.js');
...
class BehaviourEventRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type BehaviourEventRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type BehaviourEventRequest
    let len;
    let data = new BehaviourEventRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new BehaviourEventRequest(null);
...
class BehaviourEventResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type BehaviourEventResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type BehaviourEventResponse
    let len;
    let data = new BehaviourEventResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new BehaviourEventResponse(null);
...
module.exports = {
  Request: BehaviourEventRequest,
  Response: BehaviourEventResponse,
  md5sum() { return '557fe6cccaf8d1e8ba1469eb6ce305c9'; },
  datatype() { return 'pal_behaviour_msgs/BehaviourEvent'; }
};
