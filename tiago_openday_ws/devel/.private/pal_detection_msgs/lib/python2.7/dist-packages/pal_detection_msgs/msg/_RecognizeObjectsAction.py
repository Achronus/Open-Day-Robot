...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.input_image.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.action_goal.goal.input_image.format = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.action_result.result.image.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.action_result.result.image.format = str[start:end].decode('utf-8')
      else:
