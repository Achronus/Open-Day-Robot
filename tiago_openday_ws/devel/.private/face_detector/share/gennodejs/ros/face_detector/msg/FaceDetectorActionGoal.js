...
class FaceDetectorActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = FaceDetectorGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FaceDetectorActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = FaceDetectorGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new FaceDetectorGoal()
    }
